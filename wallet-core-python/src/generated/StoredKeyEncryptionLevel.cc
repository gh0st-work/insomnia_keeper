...
// Create PyStoredKeyEncryptionLevel from enum TWStoredKeyEncryptionLevel. It returns the same PyStoredKeyEncryptionLevel instance
// for the same enum TWStoredKeyEncryptionLevel value.
PyObject* PyStoredKeyEncryptionLevel_FromTWStoredKeyEncryptionLevel(TWStoredKeyEncryptionLevel value) {
  Constant* constant =
      std::find_if(std::begin(constants), std::end(constants),
                   [value](const Constant& v) { return v.value == value; });

  if (!constant) {
    PyErr_Format(PyExc_ValueError, "Invalid StoredKeyEncryptionLevel value: %d", value);
    return nullptr;
  }

  if (!constant->pyvalue) {
    auto* pyvalue = PyObject_New(PyStoredKeyEncryptionLevelObject, &PyStoredKeyEncryptionLevelType);
...
TWStoredKeyEncryptionLevel PyStoredKeyEncryptionLevel_GetTWStoredKeyEncryptionLevel(PyObject* object) {
  assert(PyStoredKeyEncryptionLevel_Check(object));
  return ((PyStoredKeyEncryptionLevelObject*)object)->value;
}

static int PyStoredKeyEncryptionLevel_init(PyStoredKeyEncryptionLevelObject *self, PyObject *args, PyObject *kwds) {
  return 0;
}

static PyObject* PyStoredKeyEncryptionLevel_new(PyTypeObject *subtype, PyObject *args, PyObject *kwds) {
  int value = 0;
  if (!PyArg_ParseTuple(args, "|i", &value)) {
    return nullptr;
  }
  return PyStoredKeyEncryptionLevel_FromTWStoredKeyEncryptionLevel((TWStoredKeyEncryptionLevel)value);
}

static PyObject* PyStoredKeyEncryptionLevel_str(PyStoredKeyEncryptionLevelObject *self) {
  Constant* constant =
      std::find_if(std::begin(constants), std::end(constants),
...
bool PyInit_StoredKeyEncryptionLevel(PyObject *module) {
  ...
  PyStoredKeyEncryptionLevelType.tp_init = (initproc)PyStoredKeyEncryptionLevel_init;
  PyStoredKeyEncryptionLevelType.tp_str = (reprfunc)PyStoredKeyEncryptionLevel_str;
  ...
  if (PyModule_AddObject(module, "StoredKeyEncryptionLevel", (PyObject *) &PyStoredKeyEncryptionLevelType) < 0) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyStoredKeyEncryptionLevel_FromTWStoredKeyEncryptionLevel(constant.value));
  }

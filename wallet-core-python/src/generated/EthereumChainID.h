...
// Note: it returns the same PyEthereumChainID instance for the same enum TWEthereumChainID value.
...
// Initialize for PyEthereumChainID. It is called by python module init function.

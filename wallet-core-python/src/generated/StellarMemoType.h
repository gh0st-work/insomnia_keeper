...
// Note: it returns the same PyStellarMemoType instance for the same enum TWStellarMemoType value.
...
// Initialize for PyStellarMemoType. It is called by python module init function.

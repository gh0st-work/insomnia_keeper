...
// Note: it returns the same PyStellarVersionByte instance for the same enum TWStellarVersionByte value.
...
// Initialize for PyStellarVersionByte. It is called by python module init function.

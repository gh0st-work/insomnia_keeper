...
// Create PyStellarVersionByte from enum TWStellarVersionByte. It returns the same PyStellarVersionByte instance
// for the same enum TWStellarVersionByte value.
...
TWStellarVersionByte PyStellarVersionByte_GetTWStellarVersionByte(PyObject* object) {
...
bool PyInit_StellarVersionByte(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyStellarVersionByte_FromTWStellarVersionByte(constant.value));
  }

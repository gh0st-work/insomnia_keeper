...
static const char PyAESEncryptCBC_doc[] =
    "TWData* TWAESEncryptCBC(TWData* key, TWData* data, TWData* iv, enum TWAESPaddingMode mode)";
...
static const char PyAESDecryptCBC_doc[] =
    "TWData* TWAESDecryptCBC(TWData* key, TWData* data, TWData* iv, enum TWAESPaddingMode mode)";
...
static const PyMethodDef method_defs[] = {{ "encrypt_cbc", (PyCFunction)PyAESEncryptCBC, METH_FASTCALL | METH_STATIC, PyAESEncryptCBC_doc },{ "decrypt_cbc", (PyCFunction)PyAESDecryptCBC, METH_FASTCALL | METH_STATIC, PyAESDecryptCBC_doc },{ "encrypt_ctr", (PyCFunction)PyAESEncryptCTR, METH_FASTCALL | METH_STATIC, PyAESEncryptCTR_doc },{ "decrypt_ctr", (PyCFunction)PyAESDecryptCTR, METH_FASTCALL | METH_STATIC, PyAESDecryptCTR_doc },{}
};

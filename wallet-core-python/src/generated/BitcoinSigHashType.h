...
// Note: it returns the same PyBitcoinSigHashType instance for the same enum TWBitcoinSigHashType value.
...
// Initialize for PyBitcoinSigHashType. It is called by python module init function.

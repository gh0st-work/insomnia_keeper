...
// Create PyStellarPassphrase from enum TWStellarPassphrase. It returns the same PyStellarPassphrase instance
// for the same enum TWStellarPassphrase value.
...
bool PyInit_StellarPassphrase(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyStellarPassphrase_FromTWStellarPassphrase(constant.value));
  }

...
// Create PyPublicKeyType from enum TWPublicKeyType. It returns the same PyPublicKeyType instance
// for the same enum TWPublicKeyType value.
...
bool PyInit_PublicKeyType(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyPublicKeyType_FromTWPublicKeyType(constant.value));
  }

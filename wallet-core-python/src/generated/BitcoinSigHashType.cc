...
// Create PyBitcoinSigHashType from enum TWBitcoinSigHashType. It returns the same PyBitcoinSigHashType instance
// for the same enum TWBitcoinSigHashType value.
...
TWBitcoinSigHashType PyBitcoinSigHashType_GetTWBitcoinSigHashType(PyObject* object) {
...
static const PyMethodDef method_defs[] = {{ "is_single", (PyCFunction)PyBitcoinSigHashTypeIsSingle, METH_FASTCALL, PyBitcoinSigHashTypeIsSingle_doc },{ "is_none", (PyCFunction)PyBitcoinSigHashTypeIsNone, METH_FASTCALL, PyBitcoinSigHashTypeIsNone_doc },{}
};
...
bool PyInit_BitcoinSigHashType(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyBitcoinSigHashType_FromTWBitcoinSigHashType(constant.value));
  }

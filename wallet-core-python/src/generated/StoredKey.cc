...
static PyObject* PyStoredKeyEncryptionParameters(PyStoredKeyObject *self, void *) {
...
static const char PyStoredKeyAccountForCoin_doc[] =
    "struct TWAccount* TWStoredKeyAccountForCoin(struct TWStoredKey* key, enum TWCoinType coin, struct TWHDWallet* wallet)";
...
static const char PyStoredKeyRemoveAccountForCoin_doc[] =
    "void TWStoredKeyRemoveAccountForCoin(struct TWStoredKey* key, enum TWCoinType coin)";
...
static const char PyStoredKeyAddAccount_doc[] =
    "void TWStoredKeyAddAccount(struct TWStoredKey* key, TWString* address, enum TWCoinType coin, TWString* derivationPath, TWString* extetndedPublicKey)";
static PyObject* PyStoredKeyAddAccount(PyStoredKeyObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  
  if (nargs != 4) {
    PyErr_Format(PyExc_TypeError, "Expect 4 args, but %d args are passed in.", nargs);
    return nullptr;
  }
...
static const char PyStoredKeyDecryptPrivateKey_doc[] =
    "TWData* TWStoredKeyDecryptPrivateKey(struct TWStoredKey* key, TWData* password)";
...
static const char PyStoredKeyDecryptMnemonic_doc[] =
    "TWString* TWStoredKeyDecryptMnemonic(struct TWStoredKey* key, TWData* password)";
...
static const char PyStoredKeyPrivateKey_doc[] =
    "struct TWPrivateKey* TWStoredKeyPrivateKey(struct TWStoredKey* key, enum TWCoinType coin, TWData* password)";
...
static const char PyStoredKeyWallet_doc[] =
    "struct TWHDWallet* TWStoredKeyWallet(struct TWStoredKey* key, TWData* password)";
...
static const char PyStoredKeyImportPrivateKey_doc[] =
    "struct TWStoredKey* TWStoredKeyImportPrivateKey(TWData* privateKey, TWString* name, TWData* password, enum TWCoinType coin)";
static PyObject* PyStoredKeyImportPrivateKey(PyStoredKeyObject *self,
  ...
  TWStoredKey* result = TWStoredKeyImportPrivateKey(arg0.get(), arg1.get(), arg2.get(), arg3);
  return PyStoredKey_FromTWStoredKey(result);
}
...
static const char PyStoredKeyImportHDWallet_doc[] =
    "struct TWStoredKey* TWStoredKeyImportHDWallet(TWString* mnemonic, TWString* name, TWData* password, enum TWCoinType coin)";
static PyObject* PyStoredKeyImportHDWallet(PyStoredKeyObject *self,
  ...
  TWStoredKey* result = TWStoredKeyImportHDWallet(arg0.get(), arg1.get(), arg2.get(), arg3);
  return PyStoredKey_FromTWStoredKey(result);
}
...
static const char PyStoredKeyCreateLevel_doc[] =
    "struct TWStoredKey* TWStoredKeyCreateLevel(TWString* name, TWData* password, enum TWStoredKeyEncryptionLevel encryptionLevel)";
static PyObject* PyStoredKeyCreateLevel(PyStoredKeyObject *self,
  ...
  if (!PyStoredKeyEncryptionLevel_Check(args[2])) {
    PyErr_SetString(PyExc_TypeError, "The arg 2 is not in type StoredKeyEncryptionLevel");
    return nullptr;
  }
...
static const PyGetSetDef get_set_defs[] = {{ "identifier", (getter)PyStoredKeyIdentifier, nullptr, PyStoredKeyIdentifier_doc },{ "name", (getter)PyStoredKeyName, nullptr, PyStoredKeyName_doc },{ "is_mnemonic", (getter)PyStoredKeyIsMnemonic, nullptr, PyStoredKeyIsMnemonic_doc },{ "account_count", (getter)PyStoredKeyAccountCount, nullptr, PyStoredKeyAccountCount_doc },{ "encryption_parameters", (getter)PyStoredKeyEncryptionParameters, nullptr, PyStoredKeyEncryptionParameters_doc },{}
};

static const PyMethodDef method_defs[] = {{ "account", (PyCFunction)PyStoredKeyAccount, METH_FASTCALL, PyStoredKeyAccount_doc },{ "account_for_coin", (PyCFunction)PyStoredKeyAccountForCoin, METH_FASTCALL, PyStoredKeyAccountForCoin_doc },{ "remove_account_for_coin", (PyCFunction)PyStoredKeyRemoveAccountForCoin, METH_FASTCALL, PyStoredKeyRemoveAccountForCoin_doc },{ "add_account", (PyCFunction)PyStoredKeyAddAccount, METH_FASTCALL, PyStoredKeyAddAccount_doc },{ "store", (PyCFunction)PyStoredKeyStore, METH_FASTCALL, PyStoredKeyStore_doc },{ "decrypt_private_key", (PyCFunction)PyStoredKeyDecryptPrivateKey, METH_FASTCALL, PyStoredKeyDecryptPrivateKey_doc },{ "decrypt_mnemonic", (PyCFunction)PyStoredKeyDecryptMnemonic, METH_FASTCALL, PyStoredKeyDecryptMnemonic_doc },{ "private_key", (PyCFunction)PyStoredKeyPrivateKey, METH_FASTCALL, PyStoredKeyPrivateKey_doc },{ "wallet", (PyCFunction)PyStoredKeyWallet, METH_FASTCALL, PyStoredKeyWallet_doc },{ "export_json", (PyCFunction)PyStoredKeyExportJSON, METH_FASTCALL, PyStoredKeyExportJSON_doc },{ "fix_addresses", (PyCFunction)PyStoredKeyFixAddresses, METH_FASTCALL, PyStoredKeyFixAddresses_doc },{ "load", (PyCFunction)PyStoredKeyLoad, METH_FASTCALL | METH_STATIC, PyStoredKeyLoad_doc },{ "import_private_key", (PyCFunction)PyStoredKeyImportPrivateKey, METH_FASTCALL | METH_STATIC, PyStoredKeyImportPrivateKey_doc },{ "import_hdwallet", (PyCFunction)PyStoredKeyImportHDWallet, METH_FASTCALL | METH_STATIC, PyStoredKeyImportHDWallet_doc },{ "import_json", (PyCFunction)PyStoredKeyImportJSON, METH_FASTCALL | METH_STATIC, PyStoredKeyImportJSON_doc },{ "create_level", (PyCFunction)PyStoredKeyCreateLevel, METH_FASTCALL | METH_STATIC, PyStoredKeyCreateLevel_doc },{ "create", (PyCFunction)PyStoredKeyCreate, METH_FASTCALL | METH_STATIC, PyStoredKeyCreate_doc },{}
};
...
bool PyInit_StoredKey(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "StoredKey", (PyObject *) &PyStoredKeyType) < 0) {

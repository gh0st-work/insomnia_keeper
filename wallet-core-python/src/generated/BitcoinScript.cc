...
PyObject* PyBitcoinScript_FromTWBitcoinScript(TWBitcoinScript* value) {
  ...
  PyBitcoinScriptObject* object = PyObject_New(PyBitcoinScriptObject, &PyBitcoinScriptType);
  if (!object)
    return nullptr;
...
static PyObject* PyBitcoinScriptIsPayToScriptHash(PyBitcoinScriptObject *self, void *) {
...
static PyObject* PyBitcoinScriptIsPayToWitnessScriptHash(PyBitcoinScriptObject *self, void *) {
...
static PyObject* PyBitcoinScriptIsPayToWitnessPublicKeyHash(PyBitcoinScriptObject *self, void *) {
...
static PyObject* PyBitcoinScriptIsWitnessProgram(PyBitcoinScriptObject *self, void *) {
...
static PyObject* PyBitcoinScriptMatchPayToPubkeyHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyBitcoinScriptMatchPayToScriptHash_doc[] =
    "TWData* TWBitcoinScriptMatchPayToScriptHash(const struct TWBitcoinScript* script)";
static PyObject* PyBitcoinScriptMatchPayToScriptHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyBitcoinScriptMatchPayToWitnessPublicKeyHash_doc[] =
    "TWData* TWBitcoinScriptMatchPayToWitnessPublicKeyHash(const struct TWBitcoinScript* script)";
static PyObject* PyBitcoinScriptMatchPayToWitnessPublicKeyHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyBitcoinScriptMatchPayToWitnessScriptHash_doc[] =
    "TWData* TWBitcoinScriptMatchPayToWitnessScriptHash(const struct TWBitcoinScript* script)";
static PyObject* PyBitcoinScriptMatchPayToWitnessScriptHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyBitcoinScriptEqual_doc[] =
    "bool TWBitcoinScriptEqual(const struct TWBitcoinScript* lhs, const struct TWBitcoinScript* rhs)";
...
static PyObject* PyBitcoinScriptBuildPayToPublicKeyHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static PyObject* PyBitcoinScriptBuildPayToScriptHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static PyObject* PyBitcoinScriptBuildPayToWitnessPubkeyHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWBitcoinScript* result = TWBitcoinScriptBuildPayToWitnessPubkeyHash(arg0.get());
  return PyBitcoinScript_FromTWBitcoinScript(result);
}
...
static PyObject* PyBitcoinScriptBuildPayToWitnessScriptHash(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWBitcoinScript* result = TWBitcoinScriptBuildPayToWitnessScriptHash(arg0.get());
  return PyBitcoinScript_FromTWBitcoinScript(result);
}
...
static const char PyBitcoinScriptLockScriptForAddress_doc[] =
    "struct TWBitcoinScript* TWBitcoinScriptLockScriptForAddress(TWString* address, enum TWCoinType coin)";
static PyObject* PyBitcoinScriptLockScriptForAddress(PyBitcoinScriptObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWBitcoinScript* result = TWBitcoinScriptLockScriptForAddress(arg0.get(), arg1);
  return PyBitcoinScript_FromTWBitcoinScript(result);
}
...
static const PyGetSetDef get_set_defs[] = {{ "size", (getter)PyBitcoinScriptSize, nullptr, PyBitcoinScriptSize_doc },{ "data", (getter)PyBitcoinScriptData, nullptr, PyBitcoinScriptData_doc },{ "script_hash", (getter)PyBitcoinScriptScriptHash, nullptr, PyBitcoinScriptScriptHash_doc },{ "is_pay_to_script_hash", (getter)PyBitcoinScriptIsPayToScriptHash, nullptr, PyBitcoinScriptIsPayToScriptHash_doc },{ "is_pay_to_witness_script_hash", (getter)PyBitcoinScriptIsPayToWitnessScriptHash, nullptr, PyBitcoinScriptIsPayToWitnessScriptHash_doc },{ "is_pay_to_witness_public_key_hash", (getter)PyBitcoinScriptIsPayToWitnessPublicKeyHash, nullptr, PyBitcoinScriptIsPayToWitnessPublicKeyHash_doc },{ "is_witness_program", (getter)PyBitcoinScriptIsWitnessProgram, nullptr, PyBitcoinScriptIsWitnessProgram_doc },{}
};

static const PyMethodDef method_defs[] = {{ "match_pay_to_pubkey", (PyCFunction)PyBitcoinScriptMatchPayToPubkey, METH_FASTCALL, PyBitcoinScriptMatchPayToPubkey_doc },{ "match_pay_to_pubkey_hash", (PyCFunction)PyBitcoinScriptMatchPayToPubkeyHash, METH_FASTCALL, PyBitcoinScriptMatchPayToPubkeyHash_doc },{ "match_pay_to_script_hash", (PyCFunction)PyBitcoinScriptMatchPayToScriptHash, METH_FASTCALL, PyBitcoinScriptMatchPayToScriptHash_doc },{ "match_pay_to_witness_public_key_hash", (PyCFunction)PyBitcoinScriptMatchPayToWitnessPublicKeyHash, METH_FASTCALL, PyBitcoinScriptMatchPayToWitnessPublicKeyHash_doc },{ "match_pay_to_witness_script_hash", (PyCFunction)PyBitcoinScriptMatchPayToWitnessScriptHash, METH_FASTCALL, PyBitcoinScriptMatchPayToWitnessScriptHash_doc },{ "encode", (PyCFunction)PyBitcoinScriptEncode, METH_FASTCALL, PyBitcoinScriptEncode_doc },{ "create", (PyCFunction)PyBitcoinScriptCreate, METH_FASTCALL | METH_STATIC, PyBitcoinScriptCreate_doc },{ "create_with_data", (PyCFunction)PyBitcoinScriptCreateWithData, METH_FASTCALL | METH_STATIC, PyBitcoinScriptCreateWithData_doc },{ "create_copy", (PyCFunction)PyBitcoinScriptCreateCopy, METH_FASTCALL | METH_STATIC, PyBitcoinScriptCreateCopy_doc },{ "equal", (PyCFunction)PyBitcoinScriptEqual, METH_FASTCALL | METH_STATIC, PyBitcoinScriptEqual_doc },{ "build_pay_to_public_key", (PyCFunction)PyBitcoinScriptBuildPayToPublicKey, METH_FASTCALL | METH_STATIC, PyBitcoinScriptBuildPayToPublicKey_doc },{ "build_pay_to_public_key_hash", (PyCFunction)PyBitcoinScriptBuildPayToPublicKeyHash, METH_FASTCALL | METH_STATIC, PyBitcoinScriptBuildPayToPublicKeyHash_doc },{ "build_pay_to_script_hash", (PyCFunction)PyBitcoinScriptBuildPayToScriptHash, METH_FASTCALL | METH_STATIC, PyBitcoinScriptBuildPayToScriptHash_doc },{ "build_pay_to_witness_pubkey_hash", (PyCFunction)PyBitcoinScriptBuildPayToWitnessPubkeyHash, METH_FASTCALL | METH_STATIC, PyBitcoinScriptBuildPayToWitnessPubkeyHash_doc },{ "build_pay_to_witness_script_hash", (PyCFunction)PyBitcoinScriptBuildPayToWitnessScriptHash, METH_FASTCALL | METH_STATIC, PyBitcoinScriptBuildPayToWitnessScriptHash_doc },{ "lock_script_for_address", (PyCFunction)PyBitcoinScriptLockScriptForAddress, METH_FASTCALL | METH_STATIC, PyBitcoinScriptLockScriptForAddress_doc },{ "hash_type_for_coin", (PyCFunction)PyBitcoinScriptHashTypeForCoin, METH_FASTCALL | METH_STATIC, PyBitcoinScriptHashTypeForCoin_doc },{}
};
...
bool PyInit_BitcoinScript(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "BitcoinScript", (PyObject *) &PyBitcoinScriptType) < 0) {

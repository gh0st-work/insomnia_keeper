...
static PyObject* PyEthereumAbiEncode(PyEthereumAbiObject *self,
  ...
  if (!PyEthereumAbiFunction_Check(args[0])) {
    PyErr_SetString(PyExc_TypeError, "The arg 0 is not in type EthereumAbiFunction");
    return nullptr;
  }
...
static const char PyEthereumAbiDecodeOutput_doc[] =
    "bool TWEthereumAbiDecodeOutput(struct TWEthereumAbiFunction* fn, TWData* encoded)";
...
static const PyMethodDef method_defs[] = {{ "encode", (PyCFunction)PyEthereumAbiEncode, METH_FASTCALL | METH_STATIC, PyEthereumAbiEncode_doc },{ "decode_output", (PyCFunction)PyEthereumAbiDecodeOutput, METH_FASTCALL | METH_STATIC, PyEthereumAbiDecodeOutput_doc },{ "decode_call", (PyCFunction)PyEthereumAbiDecodeCall, METH_FASTCALL | METH_STATIC, PyEthereumAbiDecodeCall_doc },{ "encode_typed", (PyCFunction)PyEthereumAbiEncodeTyped, METH_FASTCALL | METH_STATIC, PyEthereumAbiEncodeTyped_doc },{}
};
...
bool PyInit_EthereumAbi(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "EthereumAbi", (PyObject *) &PyEthereumAbiType) < 0) {

...
PyObject* PyPrivateKey_FromTWPrivateKey(TWPrivateKey* value) {
  ...
  PyPrivateKeyObject* object = PyObject_New(PyPrivateKeyObject, &PyPrivateKeyType);
  if (!object)
    return nullptr;
...
static const char PyPrivateKeyGetPublicKeySecp256k1_doc[] =
    "struct TWPublicKey* TWPrivateKeyGetPublicKeySecp256k1(struct TWPrivateKey* pk, bool compressed)";
...
static const char PyPrivateKeyGetPublicKeyNist256p1_doc[] =
    "struct TWPublicKey* TWPrivateKeyGetPublicKeyNist256p1(struct TWPrivateKey* pk)";
...
static const char PyPrivateKeyGetPublicKeyEd25519Blake2b_doc[] =
    "struct TWPublicKey* TWPrivateKeyGetPublicKeyEd25519Blake2b(struct TWPrivateKey* pk)";
static PyObject* PyPrivateKeyGetPublicKeyEd25519Blake2b(PyPrivateKeyObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyPrivateKeyGetPublicKeyEd25519Extended_doc[] =
    "struct TWPublicKey* TWPrivateKeyGetPublicKeyEd25519Extended(struct TWPrivateKey* pk)";
static PyObject* PyPrivateKeyGetPublicKeyEd25519Extended(PyPrivateKeyObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyPrivateKeyGetPublicKeyCurve25519_doc[] =
    "struct TWPublicKey* TWPrivateKeyGetPublicKeyCurve25519(struct TWPrivateKey* pk)";
...
static const char PyPrivateKeyGetSharedKey_doc[] =
    "TWData* TWPrivateKeyGetSharedKey(const struct TWPrivateKey* pk, const struct TWPublicKey* publicKey, enum TWCurve curve)";
...
static const char PyPrivateKeySign_doc[] =
    "TWData* TWPrivateKeySign(struct TWPrivateKey* pk, TWData* digest, enum TWCurve curve)";
...
static const char PyPrivateKeySignAsDER_doc[] =
    "TWData* TWPrivateKeySignAsDER(struct TWPrivateKey* pk, TWData* digest, enum TWCurve curve)";
...
static const char PyPrivateKeySignSchnorr_doc[] =
    "TWData* TWPrivateKeySignSchnorr(struct TWPrivateKey* pk, TWData* message, enum TWCurve curve)";
...
static const PyGetSetDef get_set_defs[] = {{ "data", (getter)PyPrivateKeyData, nullptr, PyPrivateKeyData_doc },{}
};

static const PyMethodDef method_defs[] = {{ "get_public_key_secp256k1", (PyCFunction)PyPrivateKeyGetPublicKeySecp256k1, METH_FASTCALL, PyPrivateKeyGetPublicKeySecp256k1_doc },{ "get_public_key_nist256p1", (PyCFunction)PyPrivateKeyGetPublicKeyNist256p1, METH_FASTCALL, PyPrivateKeyGetPublicKeyNist256p1_doc },{ "get_public_key_ed25519", (PyCFunction)PyPrivateKeyGetPublicKeyEd25519, METH_FASTCALL, PyPrivateKeyGetPublicKeyEd25519_doc },{ "get_public_key_ed25519_blake2b", (PyCFunction)PyPrivateKeyGetPublicKeyEd25519Blake2b, METH_FASTCALL, PyPrivateKeyGetPublicKeyEd25519Blake2b_doc },{ "get_public_key_ed25519_extended", (PyCFunction)PyPrivateKeyGetPublicKeyEd25519Extended, METH_FASTCALL, PyPrivateKeyGetPublicKeyEd25519Extended_doc },{ "get_public_key_curve25519", (PyCFunction)PyPrivateKeyGetPublicKeyCurve25519, METH_FASTCALL, PyPrivateKeyGetPublicKeyCurve25519_doc },{ "get_shared_key", (PyCFunction)PyPrivateKeyGetSharedKey, METH_FASTCALL, PyPrivateKeyGetSharedKey_doc },{ "sign", (PyCFunction)PyPrivateKeySign, METH_FASTCALL, PyPrivateKeySign_doc },{ "sign_as_der", (PyCFunction)PyPrivateKeySignAsDER, METH_FASTCALL, PyPrivateKeySignAsDER_doc },{ "sign_schnorr", (PyCFunction)PyPrivateKeySignSchnorr, METH_FASTCALL, PyPrivateKeySignSchnorr_doc },{ "create", (PyCFunction)PyPrivateKeyCreate, METH_FASTCALL | METH_STATIC, PyPrivateKeyCreate_doc },{ "create_with_data", (PyCFunction)PyPrivateKeyCreateWithData, METH_FASTCALL | METH_STATIC, PyPrivateKeyCreateWithData_doc },{ "create_copy", (PyCFunction)PyPrivateKeyCreateCopy, METH_FASTCALL | METH_STATIC, PyPrivateKeyCreateCopy_doc },{ "is_valid", (PyCFunction)PyPrivateKeyIsValid, METH_FASTCALL | METH_STATIC, PyPrivateKeyIsValid_doc },{}
};
...
bool PyInit_PrivateKey(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "PrivateKey", (PyObject *) &PyPrivateKeyType) < 0) {

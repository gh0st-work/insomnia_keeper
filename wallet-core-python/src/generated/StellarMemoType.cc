...
// Create PyStellarMemoType from enum TWStellarMemoType. It returns the same PyStellarMemoType instance
// for the same enum TWStellarMemoType value.
...
bool PyInit_StellarMemoType(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyStellarMemoType_FromTWStellarMemoType(constant.value));
  }

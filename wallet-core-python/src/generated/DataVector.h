...
// Returns true if the object is a PyDataVector.
bool PyDataVector_Check(PyObject* object);

// Create PyDataVector from an TWDataVector.
PyObject* PyDataVector_FromTWDataVector(TWDataVector* value);

// Get enum TWDataVector value from a PyDataVector object.
TWDataVector* PyDataVector_GetTWDataVector(PyObject* object);

// Initialize for PyDataVector. It is called by python module init function.

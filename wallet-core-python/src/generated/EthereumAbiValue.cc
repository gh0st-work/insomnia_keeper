...
static PyObject* PyEthereumAbiValueEncodeBytesDyn(PyEthereumAbiValueObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const PyMethodDef method_defs[] = {{ "encode_bool", (PyCFunction)PyEthereumAbiValueEncodeBool, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeBool_doc },{ "encode_int32", (PyCFunction)PyEthereumAbiValueEncodeInt32, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeInt32_doc },{ "encode_uint32", (PyCFunction)PyEthereumAbiValueEncodeUInt32, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeUInt32_doc },{ "encode_int256", (PyCFunction)PyEthereumAbiValueEncodeInt256, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeInt256_doc },{ "encode_uint256", (PyCFunction)PyEthereumAbiValueEncodeUInt256, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeUInt256_doc },{ "encode_address", (PyCFunction)PyEthereumAbiValueEncodeAddress, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeAddress_doc },{ "encode_string", (PyCFunction)PyEthereumAbiValueEncodeString, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeString_doc },{ "encode_bytes", (PyCFunction)PyEthereumAbiValueEncodeBytes, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeBytes_doc },{ "encode_bytes_dyn", (PyCFunction)PyEthereumAbiValueEncodeBytesDyn, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueEncodeBytesDyn_doc },{ "decode_uint256", (PyCFunction)PyEthereumAbiValueDecodeUInt256, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueDecodeUInt256_doc },{ "decode_value", (PyCFunction)PyEthereumAbiValueDecodeValue, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueDecodeValue_doc },{ "decode_array", (PyCFunction)PyEthereumAbiValueDecodeArray, METH_FASTCALL | METH_STATIC, PyEthereumAbiValueDecodeArray_doc },{}
};
...
bool PyInit_EthereumAbiValue(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "EthereumAbiValue", (PyObject *) &PyEthereumAbiValueType) < 0) {

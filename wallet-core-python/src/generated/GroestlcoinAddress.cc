...
PyObject* PyGroestlcoinAddress_FromTWGroestlcoinAddress(TWGroestlcoinAddress* value) {
  if (!value)
    Py_RETURN_NONE;

  PyGroestlcoinAddressObject* object = PyObject_New(PyGroestlcoinAddressObject, &PyGroestlcoinAddressType);
  if (!object)
    return nullptr;
...
TWGroestlcoinAddress* PyGroestlcoinAddress_GetTWGroestlcoinAddress(PyObject* object) {
...
static const char PyGroestlcoinAddressDescription_doc[] =
    "TWString* TWGroestlcoinAddressDescription(struct TWGroestlcoinAddress* address)";
static PyObject* PyGroestlcoinAddressDescription(PyGroestlcoinAddressObject *self, void *) {
...
static PyObject* PyGroestlcoinAddressEqual(PyGroestlcoinAddressObject *self,
  ...
  if (!PyGroestlcoinAddress_Check(args[0])) {
    PyErr_SetString(PyExc_TypeError, "The arg 0 is not in type GroestlcoinAddress");
    return nullptr;
  }
  ...
  if (!PyGroestlcoinAddress_Check(args[1])) {
    PyErr_SetString(PyExc_TypeError, "The arg 1 is not in type GroestlcoinAddress");
    return nullptr;
  }
...
static PyObject* PyGroestlcoinAddressIsValidString(PyGroestlcoinAddressObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyGroestlcoinAddressCreateWithString_doc[] =
    "struct TWGroestlcoinAddress* TWGroestlcoinAddressCreateWithString(TWString* string)";
static PyObject* PyGroestlcoinAddressCreateWithString(PyGroestlcoinAddressObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWGroestlcoinAddress* result = TWGroestlcoinAddressCreateWithString(arg0.get());
...
static const char PyGroestlcoinAddressCreateWithPublicKey_doc[] =
    "struct TWGroestlcoinAddress* TWGroestlcoinAddressCreateWithPublicKey(struct TWPublicKey* publicKey, uint8_t prefix)";
static PyObject* PyGroestlcoinAddressCreateWithPublicKey(PyGroestlcoinAddressObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWGroestlcoinAddress* result = TWGroestlcoinAddressCreateWithPublicKey(arg0, arg1);
  return PyGroestlcoinAddress_FromTWGroestlcoinAddress(result);
}
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PyGroestlcoinAddressDescription, nullptr, PyGroestlcoinAddressDescription_doc },{}
};

static const PyMethodDef method_defs[] = {{ "equal", (PyCFunction)PyGroestlcoinAddressEqual, METH_FASTCALL | METH_STATIC, PyGroestlcoinAddressEqual_doc },{ "is_valid_string", (PyCFunction)PyGroestlcoinAddressIsValidString, METH_FASTCALL | METH_STATIC, PyGroestlcoinAddressIsValidString_doc },{ "create_with_string", (PyCFunction)PyGroestlcoinAddressCreateWithString, METH_FASTCALL | METH_STATIC, PyGroestlcoinAddressCreateWithString_doc },{ "create_with_public_key", (PyCFunction)PyGroestlcoinAddressCreateWithPublicKey, METH_FASTCALL | METH_STATIC, PyGroestlcoinAddressCreateWithPublicKey_doc },{}
};

bool PyInit_GroestlcoinAddress(PyObject *module) {
  PyGroestlcoinAddressType.tp_dealloc = (destructor)PyGroestlcoinAddress_dealloc;
  ...
  if (PyModule_AddObject(module, "GroestlcoinAddress", (PyObject *) &PyGroestlcoinAddressType) < 0) {

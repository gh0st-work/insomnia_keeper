...
PyObject* PyNEARAccount_FromTWNEARAccount(TWNEARAccount* value) {
  ...
  PyNEARAccountObject* object = PyObject_New(PyNEARAccountObject, &PyNEARAccountType);
  if (!object)
    return nullptr;
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PyNEARAccountDescription, nullptr, PyNEARAccountDescription_doc },{}
};

static const PyMethodDef method_defs[] = {{ "create_with_string", (PyCFunction)PyNEARAccountCreateWithString, METH_FASTCALL | METH_STATIC, PyNEARAccountCreateWithString_doc },{}
};
...
bool PyInit_NEARAccount(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "NEARAccount", (PyObject *) &PyNEARAccountType) < 0) {

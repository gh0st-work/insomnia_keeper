...
// Note: it returns the same PySS58AddressType instance for the same enum TWSS58AddressType value.
...
// Initialize for PySS58AddressType. It is called by python module init function.

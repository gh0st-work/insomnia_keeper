...
static PyObject* PyCoinTypeConfigurationGetSymbol(PyCoinTypeConfigurationObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static PyObject* PyCoinTypeConfigurationGetDecimals(PyCoinTypeConfigurationObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyCoinTypeConfigurationGetTransactionURL_doc[] =
    "TWString* TWCoinTypeConfigurationGetTransactionURL(enum TWCoinType type, TWString* transactionID)";
static PyObject* PyCoinTypeConfigurationGetTransactionURL(PyCoinTypeConfigurationObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWStringPtr result(TWCoinTypeConfigurationGetTransactionURL(arg0, arg1.get()));
  return PyUnicode_FromTWString(result);
}
...
static const char PyCoinTypeConfigurationGetAccountURL_doc[] =
    "TWString* TWCoinTypeConfigurationGetAccountURL(enum TWCoinType type, TWString* accountID)";
static PyObject* PyCoinTypeConfigurationGetAccountURL(PyCoinTypeConfigurationObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static PyObject* PyCoinTypeConfigurationGetID(PyCoinTypeConfigurationObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static PyObject* PyCoinTypeConfigurationGetName(PyCoinTypeConfigurationObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const PyMethodDef method_defs[] = {{ "get_symbol", (PyCFunction)PyCoinTypeConfigurationGetSymbol, METH_FASTCALL | METH_STATIC, PyCoinTypeConfigurationGetSymbol_doc },{ "get_decimals", (PyCFunction)PyCoinTypeConfigurationGetDecimals, METH_FASTCALL | METH_STATIC, PyCoinTypeConfigurationGetDecimals_doc },{ "get_transaction_url", (PyCFunction)PyCoinTypeConfigurationGetTransactionURL, METH_FASTCALL | METH_STATIC, PyCoinTypeConfigurationGetTransactionURL_doc },{ "get_account_url", (PyCFunction)PyCoinTypeConfigurationGetAccountURL, METH_FASTCALL | METH_STATIC, PyCoinTypeConfigurationGetAccountURL_doc },{ "get_id", (PyCFunction)PyCoinTypeConfigurationGetID, METH_FASTCALL | METH_STATIC, PyCoinTypeConfigurationGetID_doc },{ "get_name", (PyCFunction)PyCoinTypeConfigurationGetName, METH_FASTCALL | METH_STATIC, PyCoinTypeConfigurationGetName_doc },{}
};
...
bool PyInit_CoinTypeConfiguration(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "CoinTypeConfiguration", (PyObject *) &PyCoinTypeConfigurationType) < 0) {

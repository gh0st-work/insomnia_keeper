...
static const char PyPublicKeyVerifyAsDER_doc[] =
    "bool TWPublicKeyVerifyAsDER(struct TWPublicKey* pk, TWData* signature, TWData* message)";
...
static const char PyPublicKeyVerifySchnorr_doc[] =
    "bool TWPublicKeyVerifySchnorr(struct TWPublicKey* pk, TWData* signature, TWData* message)";
...
static const char PyPublicKeyCreateWithData_doc[] =
    "struct TWPublicKey* TWPublicKeyCreateWithData(TWData* data, enum TWPublicKeyType type)";
...
static const PyGetSetDef get_set_defs[] = {{ "is_compressed", (getter)PyPublicKeyIsCompressed, nullptr, PyPublicKeyIsCompressed_doc },{ "compressed", (getter)PyPublicKeyCompressed, nullptr, PyPublicKeyCompressed_doc },{ "uncompressed", (getter)PyPublicKeyUncompressed, nullptr, PyPublicKeyUncompressed_doc },{ "data", (getter)PyPublicKeyData, nullptr, PyPublicKeyData_doc },{ "key_type", (getter)PyPublicKeyKeyType, nullptr, PyPublicKeyKeyType_doc },{ "description", (getter)PyPublicKeyDescription, nullptr, PyPublicKeyDescription_doc },{}
};

static const PyMethodDef method_defs[] = {{ "verify", (PyCFunction)PyPublicKeyVerify, METH_FASTCALL, PyPublicKeyVerify_doc },{ "verify_as_der", (PyCFunction)PyPublicKeyVerifyAsDER, METH_FASTCALL, PyPublicKeyVerifyAsDER_doc },{ "verify_schnorr", (PyCFunction)PyPublicKeyVerifySchnorr, METH_FASTCALL, PyPublicKeyVerifySchnorr_doc },{ "create_with_data", (PyCFunction)PyPublicKeyCreateWithData, METH_FASTCALL | METH_STATIC, PyPublicKeyCreateWithData_doc },{ "is_valid", (PyCFunction)PyPublicKeyIsValid, METH_FASTCALL | METH_STATIC, PyPublicKeyIsValid_doc },{ "recover", (PyCFunction)PyPublicKeyRecover, METH_FASTCALL | METH_STATIC, PyPublicKeyRecover_doc },{}
};
...
bool PyInit_PublicKey(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "PublicKey", (PyObject *) &PyPublicKeyType) < 0) {

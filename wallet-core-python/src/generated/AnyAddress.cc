...
PyObject* PyAnyAddress_FromTWAnyAddress(TWAnyAddress* value) {
  ...
  PyAnyAddressObject* object = PyObject_New(PyAnyAddressObject, &PyAnyAddressType);
  if (!object)
    return nullptr;
...
static const char PyAnyAddressCreateWithString_doc[] =
    "struct TWAnyAddress* TWAnyAddressCreateWithString(TWString* string, enum TWCoinType coin)";
...
static const char PyAnyAddressCreateWithPublicKey_doc[] =
    "struct TWAnyAddress* TWAnyAddressCreateWithPublicKey(struct TWPublicKey* publicKey, enum TWCoinType coin)";
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PyAnyAddressDescription, nullptr, PyAnyAddressDescription_doc },{ "coin", (getter)PyAnyAddressCoin, nullptr, PyAnyAddressCoin_doc },{ "data", (getter)PyAnyAddressData, nullptr, PyAnyAddressData_doc },{}
};

static const PyMethodDef method_defs[] = {{ "equal", (PyCFunction)PyAnyAddressEqual, METH_FASTCALL | METH_STATIC, PyAnyAddressEqual_doc },{ "is_valid", (PyCFunction)PyAnyAddressIsValid, METH_FASTCALL | METH_STATIC, PyAnyAddressIsValid_doc },{ "create_with_string", (PyCFunction)PyAnyAddressCreateWithString, METH_FASTCALL | METH_STATIC, PyAnyAddressCreateWithString_doc },{ "create_with_public_key", (PyCFunction)PyAnyAddressCreateWithPublicKey, METH_FASTCALL | METH_STATIC, PyAnyAddressCreateWithPublicKey_doc },{}
};
...
bool PyInit_AnyAddress(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "AnyAddress", (PyObject *) &PyAnyAddressType) < 0) {

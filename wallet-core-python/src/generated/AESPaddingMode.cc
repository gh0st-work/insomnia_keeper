...
// Create PyAESPaddingMode from enum TWAESPaddingMode. It returns the same PyAESPaddingMode instance
// for the same enum TWAESPaddingMode value.
...
bool PyInit_AESPaddingMode(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyAESPaddingMode_FromTWAESPaddingMode(constant.value));
  }

...
// Create PyHDVersion from enum TWHDVersion. It returns the same PyHDVersion instance
// for the same enum TWHDVersion value.
...
static int PyHDVersion_init(PyHDVersionObject *self, PyObject *args, PyObject *kwds) {
  return 0;
}

static PyObject* PyHDVersion_new(PyTypeObject *subtype, PyObject *args, PyObject *kwds) {
  int value = 0;
...
static const PyGetSetDef get_set_defs[] = {{ "is_public", (getter)PyHDVersionIsPublic, nullptr, PyHDVersionIsPublic_doc },{ "is_private", (getter)PyHDVersionIsPrivate, nullptr, PyHDVersionIsPrivate_doc },{}
};
...
bool PyInit_HDVersion(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyHDVersion_FromTWHDVersion(constant.value));
  }

...
static const char PyPBKDF2HmacSha256_doc[] =
    "TWData* TWPBKDF2HmacSha256(TWData* password, TWData* salt, uint32_t iterations, uint32_t dkLen)";
...
static const char PyPBKDF2HmacSha512_doc[] =
    "TWData* TWPBKDF2HmacSha512(TWData* password, TWData* salt, uint32_t iterations, uint32_t dkLen)";
...
static const PyMethodDef method_defs[] = {{ "hmac_sha256", (PyCFunction)PyPBKDF2HmacSha256, METH_FASTCALL | METH_STATIC, PyPBKDF2HmacSha256_doc },{ "hmac_sha512", (PyCFunction)PyPBKDF2HmacSha512, METH_FASTCALL | METH_STATIC, PyPBKDF2HmacSha512_doc },{}
};

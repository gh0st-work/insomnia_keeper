...
PyObject* PySolanaAddress_FromTWSolanaAddress(TWSolanaAddress* value) {
  ...
  PySolanaAddressObject* object = PyObject_New(PySolanaAddressObject, &PySolanaAddressType);
  if (!object)
    return nullptr;
...
static PyObject* PySolanaAddressDescription(PySolanaAddressObject *self, void *) {
...
static const char PySolanaAddressDefaultTokenAddress_doc[] =
    "TWString* TWSolanaAddressDefaultTokenAddress(struct TWSolanaAddress* address, TWString* tokenMintAddress)";
static PyObject* PySolanaAddressDefaultTokenAddress(PySolanaAddressObject *self,
  ...
  TWStringPtr result(TWSolanaAddressDefaultTokenAddress(self->value, arg0.get()));
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PySolanaAddressDescription, nullptr, PySolanaAddressDescription_doc },{}
};

static const PyMethodDef method_defs[] = {{ "default_token_address", (PyCFunction)PySolanaAddressDefaultTokenAddress, METH_FASTCALL, PySolanaAddressDefaultTokenAddress_doc },{ "create_with_string", (PyCFunction)PySolanaAddressCreateWithString, METH_FASTCALL | METH_STATIC, PySolanaAddressCreateWithString_doc },{}
};
...
bool PyInit_SolanaAddress(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "SolanaAddress", (PyObject *) &PySolanaAddressType) < 0) {

...
// Create PySS58AddressType from enum TWSS58AddressType. It returns the same PySS58AddressType instance
// for the same enum TWSS58AddressType value.
...
bool PyInit_SS58AddressType(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PySS58AddressType_FromTWSS58AddressType(constant.value));
  }

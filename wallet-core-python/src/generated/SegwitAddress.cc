...
PyObject* PySegwitAddress_FromTWSegwitAddress(TWSegwitAddress* value) {
  ...
  PySegwitAddressObject* object = PyObject_New(PySegwitAddressObject, &PySegwitAddressType);
  if (!object)
    return nullptr;
...
static PyObject* PySegwitAddressDescription(PySegwitAddressObject *self, void *) {
...
static PyObject* PySegwitAddressWitnessVersion(PySegwitAddressObject *self, void *) {
...
static PyObject* PySegwitAddressWitnessProgram(PySegwitAddressObject *self, void *) {
...
static const char PySegwitAddressEqual_doc[] =
    "bool TWSegwitAddressEqual(struct TWSegwitAddress* lhs, struct TWSegwitAddress* rhs)";
...
static const char PySegwitAddressCreateWithPublicKey_doc[] =
    "struct TWSegwitAddress* TWSegwitAddressCreateWithPublicKey(enum TWHRP hrp, struct TWPublicKey* publicKey)";
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PySegwitAddressDescription, nullptr, PySegwitAddressDescription_doc },{ "hrp", (getter)PySegwitAddressHRP, nullptr, PySegwitAddressHRP_doc },{ "witness_version", (getter)PySegwitAddressWitnessVersion, nullptr, PySegwitAddressWitnessVersion_doc },{ "witness_program", (getter)PySegwitAddressWitnessProgram, nullptr, PySegwitAddressWitnessProgram_doc },{}
};

static const PyMethodDef method_defs[] = {{ "equal", (PyCFunction)PySegwitAddressEqual, METH_FASTCALL | METH_STATIC, PySegwitAddressEqual_doc },{ "is_valid_string", (PyCFunction)PySegwitAddressIsValidString, METH_FASTCALL | METH_STATIC, PySegwitAddressIsValidString_doc },{ "create_with_string", (PyCFunction)PySegwitAddressCreateWithString, METH_FASTCALL | METH_STATIC, PySegwitAddressCreateWithString_doc },{ "create_with_public_key", (PyCFunction)PySegwitAddressCreateWithPublicKey, METH_FASTCALL | METH_STATIC, PySegwitAddressCreateWithPublicKey_doc },{}
};
...
bool PyInit_SegwitAddress(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "SegwitAddress", (PyObject *) &PySegwitAddressType) < 0) {

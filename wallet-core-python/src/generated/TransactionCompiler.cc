...
static const char PyTransactionCompilerBuildInput_doc[] =
    "TWData* TWTransactionCompilerBuildInput(enum TWCoinType coinType, TWString* from, TWString* to, TWString* amount, TWString* asset, TWString* memo, TWString* chainId)";
static PyObject* PyTransactionCompilerBuildInput(PyTransactionCompilerObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  
  if (nargs != 7) {
    PyErr_Format(PyExc_TypeError, "Expect 7 args, but %d args are passed in.", nargs);
    return nullptr;
  }
  ...
  TWDataPtr result(TWTransactionCompilerBuildInput(arg0, arg1.get(), arg2.get(), arg3.get(), arg4.get(), arg5.get(), arg6.get()));
...
static const char PyTransactionCompilerPreImageHashes_doc[] =
    "struct TWDataVector* TWTransactionCompilerPreImageHashes(enum TWCoinType coinType, TWData* txInputData)";
static PyObject* PyTransactionCompilerPreImageHashes(PyTransactionCompilerObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const char PyTransactionCompilerCompileWithSignatures_doc[] =
    "TWData* TWTransactionCompilerCompileWithSignatures(enum TWCoinType coinType, TWData* txInputData, const struct TWDataVector* signatures, const struct TWDataVector* publicKeys)";
static PyObject* PyTransactionCompilerCompileWithSignatures(PyTransactionCompilerObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
  ...
  TWDataPtr result(TWTransactionCompilerCompileWithSignatures(arg0, arg1.get(), arg2, arg3));
  return PyBytes_FromTWData(result);
}
...
static const PyMethodDef method_defs[] = {{ "build_input", (PyCFunction)PyTransactionCompilerBuildInput, METH_FASTCALL | METH_STATIC, PyTransactionCompilerBuildInput_doc },{ "pre_image_hashes", (PyCFunction)PyTransactionCompilerPreImageHashes, METH_FASTCALL | METH_STATIC, PyTransactionCompilerPreImageHashes_doc },{ "compile_with_signatures", (PyCFunction)PyTransactionCompilerCompileWithSignatures, METH_FASTCALL | METH_STATIC, PyTransactionCompilerCompileWithSignatures_doc },{}
};
...
bool PyInit_TransactionCompiler(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "TransactionCompiler", (PyObject *) &PyTransactionCompilerType) < 0) {

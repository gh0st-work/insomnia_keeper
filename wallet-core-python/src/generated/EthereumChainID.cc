...
// Create PyEthereumChainID from enum TWEthereumChainID. It returns the same PyEthereumChainID instance
// for the same enum TWEthereumChainID value.
...
bool PyInit_EthereumChainID(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyEthereumChainID_FromTWEthereumChainID(constant.value));
  }

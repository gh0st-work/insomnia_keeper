...
static const char PyHDWalletGetMasterKey_doc[] =
    "struct TWPrivateKey* TWHDWalletGetMasterKey(struct TWHDWallet* wallet, enum TWCurve curve)";
...
static const char PyHDWalletGetKeyForCoin_doc[] =
    "struct TWPrivateKey* TWHDWalletGetKeyForCoin(struct TWHDWallet* wallet, enum TWCoinType coin)";
...
static const char PyHDWalletGetAddressForCoin_doc[] =
    "TWString* TWHDWalletGetAddressForCoin(struct TWHDWallet* wallet, enum TWCoinType coin)";
...
static const char PyHDWalletGetKey_doc[] =
    "struct TWPrivateKey* TWHDWalletGetKey(struct TWHDWallet* wallet, enum TWCoinType coin, TWString* derivationPath)";
...
static const char PyHDWalletGetDerivedKey_doc[] =
    "struct TWPrivateKey* TWHDWalletGetDerivedKey(struct TWHDWallet* wallet, enum TWCoinType coin, uint32_t account, uint32_t change, uint32_t address)";
static PyObject* PyHDWalletGetDerivedKey(PyHDWalletObject *self,
  ...
  TWPrivateKey* result = TWHDWalletGetDerivedKey(self->value, arg0, arg1, arg2, arg3);
  return PyPrivateKey_FromTWPrivateKey(result);
}
...
static const char PyHDWalletGetExtendedPrivateKey_doc[] =
    "TWString* TWHDWalletGetExtendedPrivateKey(struct TWHDWallet* wallet, enum TWPurpose purpose, enum TWCoinType coin, enum TWHDVersion version)";
static PyObject* PyHDWalletGetExtendedPrivateKey(PyHDWalletObject *self,
  ...
  TWStringPtr result(TWHDWalletGetExtendedPrivateKey(self->value, arg0, arg1, arg2));
  return PyUnicode_FromTWString(result);
}
...
static const char PyHDWalletGetExtendedPublicKey_doc[] =
    "TWString* TWHDWalletGetExtendedPublicKey(struct TWHDWallet* wallet, enum TWPurpose purpose, enum TWCoinType coin, enum TWHDVersion version)";
static PyObject* PyHDWalletGetExtendedPublicKey(PyHDWalletObject *self,
  ...
  TWStringPtr result(TWHDWalletGetExtendedPublicKey(self->value, arg0, arg1, arg2));
  return PyUnicode_FromTWString(result);
}
...
static const char PyHDWalletCreate_doc[] =
    "struct TWHDWallet* TWHDWalletCreate(int32_t strength, TWString* passphrase)";
...
static const char PyHDWalletCreateWithMnemonic_doc[] =
    "struct TWHDWallet* TWHDWalletCreateWithMnemonic(TWString* mnemonic, TWString* passphrase)";
...
static const char PyHDWalletCreateWithMnemonicCheck_doc[] =
    "struct TWHDWallet* TWHDWalletCreateWithMnemonicCheck(TWString* mnemonic, TWString* passphrase, bool check)";
static PyObject* PyHDWalletCreateWithMnemonicCheck(PyHDWalletObject *self,
  ...
  TWHDWallet* result = TWHDWalletCreateWithMnemonicCheck(arg0.get(), arg1.get(), arg2);
  return PyHDWallet_FromTWHDWallet(result);
}
...
static const char PyHDWalletCreateWithEntropy_doc[] =
    "struct TWHDWallet* TWHDWalletCreateWithEntropy(TWData* entropy, TWString* passphrase)";
...
static const char PyHDWalletGetPublicKeyFromExtended_doc[] =
    "struct TWPublicKey* TWHDWalletGetPublicKeyFromExtended(TWString* extended, enum TWCoinType coin, TWString* derivationPath)";
static PyObject* PyHDWalletGetPublicKeyFromExtended(PyHDWalletObject *self,
  ...
  TWPublicKey* result = TWHDWalletGetPublicKeyFromExtended(arg0.get(), arg1, arg2.get());
...
static const PyGetSetDef get_set_defs[] = {{ "seed", (getter)PyHDWalletSeed, nullptr, PyHDWalletSeed_doc },{ "mnemonic", (getter)PyHDWalletMnemonic, nullptr, PyHDWalletMnemonic_doc },{ "entropy", (getter)PyHDWalletEntropy, nullptr, PyHDWalletEntropy_doc },{}
};

static const PyMethodDef method_defs[] = {{ "get_master_key", (PyCFunction)PyHDWalletGetMasterKey, METH_FASTCALL, PyHDWalletGetMasterKey_doc },{ "get_key_for_coin", (PyCFunction)PyHDWalletGetKeyForCoin, METH_FASTCALL, PyHDWalletGetKeyForCoin_doc },{ "get_address_for_coin", (PyCFunction)PyHDWalletGetAddressForCoin, METH_FASTCALL, PyHDWalletGetAddressForCoin_doc },{ "get_key", (PyCFunction)PyHDWalletGetKey, METH_FASTCALL, PyHDWalletGetKey_doc },{ "get_derived_key", (PyCFunction)PyHDWalletGetDerivedKey, METH_FASTCALL, PyHDWalletGetDerivedKey_doc },{ "get_extended_private_key", (PyCFunction)PyHDWalletGetExtendedPrivateKey, METH_FASTCALL, PyHDWalletGetExtendedPrivateKey_doc },{ "get_extended_public_key", (PyCFunction)PyHDWalletGetExtendedPublicKey, METH_FASTCALL, PyHDWalletGetExtendedPublicKey_doc },{ "create", (PyCFunction)PyHDWalletCreate, METH_FASTCALL | METH_STATIC, PyHDWalletCreate_doc },{ "create_with_mnemonic", (PyCFunction)PyHDWalletCreateWithMnemonic, METH_FASTCALL | METH_STATIC, PyHDWalletCreateWithMnemonic_doc },{ "create_with_mnemonic_check", (PyCFunction)PyHDWalletCreateWithMnemonicCheck, METH_FASTCALL | METH_STATIC, PyHDWalletCreateWithMnemonicCheck_doc },{ "create_with_entropy", (PyCFunction)PyHDWalletCreateWithEntropy, METH_FASTCALL | METH_STATIC, PyHDWalletCreateWithEntropy_doc },{ "get_public_key_from_extended", (PyCFunction)PyHDWalletGetPublicKeyFromExtended, METH_FASTCALL | METH_STATIC, PyHDWalletGetPublicKeyFromExtended_doc },{}
};

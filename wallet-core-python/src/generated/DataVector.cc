...
PyObject* PyDataVector_FromTWDataVector(TWDataVector* value) {
  ...
  PyDataVectorObject* object = PyObject_New(PyDataVectorObject, &PyDataVectorType);
  if (!object)
    return nullptr;
...
static const char PyDataVectorGet_doc[] =
    "TWData* TWDataVectorGet(const struct TWDataVector* dataVector, size_t index)";
...
static const PyGetSetDef get_set_defs[] = {{ "size", (getter)PyDataVectorSize, nullptr, PyDataVectorSize_doc },{}
};

static const PyMethodDef method_defs[] = {{ "add", (PyCFunction)PyDataVectorAdd, METH_FASTCALL, PyDataVectorAdd_doc },{ "get", (PyCFunction)PyDataVectorGet, METH_FASTCALL, PyDataVectorGet_doc },{ "create", (PyCFunction)PyDataVectorCreate, METH_FASTCALL | METH_STATIC, PyDataVectorCreate_doc },{ "create_with_data", (PyCFunction)PyDataVectorCreateWithData, METH_FASTCALL | METH_STATIC, PyDataVectorCreateWithData_doc },{}
};
...
bool PyInit_DataVector(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "DataVector", (PyObject *) &PyDataVectorType) < 0) {

...
static const PyMethodDef method_defs[] = {{ "is_valid", (PyCFunction)PyMnemonicIsValid, METH_FASTCALL | METH_STATIC, PyMnemonicIsValid_doc },{ "is_valid_word", (PyCFunction)PyMnemonicIsValidWord, METH_FASTCALL | METH_STATIC, PyMnemonicIsValidWord_doc },{ "suggest", (PyCFunction)PyMnemonicSuggest, METH_FASTCALL | METH_STATIC, PyMnemonicSuggest_doc },{}
};

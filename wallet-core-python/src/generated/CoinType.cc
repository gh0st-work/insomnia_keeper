...
// Create PyCoinType from enum TWCoinType. It returns the same PyCoinType instance
// for the same enum TWCoinType value.
...
static const char PyCoinTypeDeriveAddress_doc[] =
    "TWString* TWCoinTypeDeriveAddress(enum TWCoinType coin, struct TWPrivateKey* privateKey)";
...
static const char PyCoinTypeDeriveAddressFromPublicKey_doc[] =
    "TWString* TWCoinTypeDeriveAddressFromPublicKey(enum TWCoinType coin, struct TWPublicKey* publicKey)";
...
static const PyGetSetDef get_set_defs[] = {{ "blockchain", (getter)PyCoinTypeBlockchain, nullptr, PyCoinTypeBlockchain_doc },{ "purpose", (getter)PyCoinTypePurpose, nullptr, PyCoinTypePurpose_doc },{ "curve", (getter)PyCoinTypeCurve, nullptr, PyCoinTypeCurve_doc },{ "xpub_version", (getter)PyCoinTypeXpubVersion, nullptr, PyCoinTypeXpubVersion_doc },{ "xprv_version", (getter)PyCoinTypeXprvVersion, nullptr, PyCoinTypeXprvVersion_doc },{ "hrp", (getter)PyCoinTypeHRP, nullptr, PyCoinTypeHRP_doc },{ "p2pkh_prefix", (getter)PyCoinTypeP2pkhPrefix, nullptr, PyCoinTypeP2pkhPrefix_doc },{ "p2sh_prefix", (getter)PyCoinTypeP2shPrefix, nullptr, PyCoinTypeP2shPrefix_doc },{ "static_prefix", (getter)PyCoinTypeStaticPrefix, nullptr, PyCoinTypeStaticPrefix_doc },{ "slip44_id", (getter)PyCoinTypeSlip44Id, nullptr, PyCoinTypeSlip44Id_doc },{}
};

static const PyMethodDef method_defs[] = {{ "validate", (PyCFunction)PyCoinTypeValidate, METH_FASTCALL, PyCoinTypeValidate_doc },{ "derivation_path", (PyCFunction)PyCoinTypeDerivationPath, METH_FASTCALL, PyCoinTypeDerivationPath_doc },{ "derive_address", (PyCFunction)PyCoinTypeDeriveAddress, METH_FASTCALL, PyCoinTypeDeriveAddress_doc },{ "derive_address_from_public_key", (PyCFunction)PyCoinTypeDeriveAddressFromPublicKey, METH_FASTCALL, PyCoinTypeDeriveAddressFromPublicKey_doc },{}
};
...
bool PyInit_CoinType(PyObject *module) {
  ...
  for (const Constant& constant : constants) {
    PyDict_SetItemString(dict, constant.name, PyCoinType_FromTWCoinType(constant.value));
  }

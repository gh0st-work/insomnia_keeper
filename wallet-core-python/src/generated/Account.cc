...
static const char PyAccountCreate_doc[] =
    "struct TWAccount* TWAccountCreate(TWString* address, enum TWCoinType coin, TWString* derivationPath, TWString* extendedPublicKey)";
...
static const PyGetSetDef get_set_defs[] = {{ "address", (getter)PyAccountAddress, nullptr, PyAccountAddress_doc },{ "derivation_path", (getter)PyAccountDerivationPath, nullptr, PyAccountDerivationPath_doc },{ "extended_public_key", (getter)PyAccountExtendedPublicKey, nullptr, PyAccountExtendedPublicKey_doc },{ "coin", (getter)PyAccountCoin, nullptr, PyAccountCoin_doc },{}
};

static const PyMethodDef method_defs[] = {{ "create", (PyCFunction)PyAccountCreate, METH_FASTCALL | METH_STATIC, PyAccountCreate_doc },{}
};

...
PyObject* PyRippleXAddress_FromTWRippleXAddress(TWRippleXAddress* value) {
  ...
  PyRippleXAddressObject* object = PyObject_New(PyRippleXAddressObject, &PyRippleXAddressType);
  if (!object)
    return nullptr;
...
static PyObject* PyRippleXAddressDescription(PyRippleXAddressObject *self, void *) {
...
static const char PyRippleXAddressEqual_doc[] =
    "bool TWRippleXAddressEqual(struct TWRippleXAddress* lhs, struct TWRippleXAddress* rhs)";
...
static const char PyRippleXAddressCreateWithPublicKey_doc[] =
    "struct TWRippleXAddress* TWRippleXAddressCreateWithPublicKey(struct TWPublicKey* publicKey, uint32_t tag)";
static PyObject* PyRippleXAddressCreateWithPublicKey(PyRippleXAddressObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PyRippleXAddressDescription, nullptr, PyRippleXAddressDescription_doc },{ "tag", (getter)PyRippleXAddressTag, nullptr, PyRippleXAddressTag_doc },{}
};

static const PyMethodDef method_defs[] = {{ "equal", (PyCFunction)PyRippleXAddressEqual, METH_FASTCALL | METH_STATIC, PyRippleXAddressEqual_doc },{ "is_valid_string", (PyCFunction)PyRippleXAddressIsValidString, METH_FASTCALL | METH_STATIC, PyRippleXAddressIsValidString_doc },{ "create_with_string", (PyCFunction)PyRippleXAddressCreateWithString, METH_FASTCALL | METH_STATIC, PyRippleXAddressCreateWithString_doc },{ "create_with_public_key", (PyCFunction)PyRippleXAddressCreateWithPublicKey, METH_FASTCALL | METH_STATIC, PyRippleXAddressCreateWithPublicKey_doc },{}
};
...
bool PyInit_RippleXAddress(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "RippleXAddress", (PyObject *) &PyRippleXAddressType) < 0) {

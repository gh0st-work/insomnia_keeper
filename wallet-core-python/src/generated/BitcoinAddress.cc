...
PyObject* PyBitcoinAddress_FromTWBitcoinAddress(TWBitcoinAddress* value) {
  ...
  PyBitcoinAddressObject* object = PyObject_New(PyBitcoinAddressObject, &PyBitcoinAddressType);
  if (!object)
    return nullptr;
...
static PyObject* PyBitcoinAddressDescription(PyBitcoinAddressObject *self, void *) {
...
static const char PyBitcoinAddressCreateWithPublicKey_doc[] =
    "struct TWBitcoinAddress* TWBitcoinAddressCreateWithPublicKey(struct TWPublicKey* publicKey, uint8_t prefix)";
static PyObject* PyBitcoinAddressCreateWithPublicKey(PyBitcoinAddressObject *self,
                                         PyObject *const *args,
                                         Py_ssize_t nargs) {
...
static const PyGetSetDef get_set_defs[] = {{ "description", (getter)PyBitcoinAddressDescription, nullptr, PyBitcoinAddressDescription_doc },{ "prefix", (getter)PyBitcoinAddressPrefix, nullptr, PyBitcoinAddressPrefix_doc },{ "keyhash", (getter)PyBitcoinAddressKeyhash, nullptr, PyBitcoinAddressKeyhash_doc },{}
};

static const PyMethodDef method_defs[] = {{ "equal", (PyCFunction)PyBitcoinAddressEqual, METH_FASTCALL | METH_STATIC, PyBitcoinAddressEqual_doc },{ "is_valid", (PyCFunction)PyBitcoinAddressIsValid, METH_FASTCALL | METH_STATIC, PyBitcoinAddressIsValid_doc },{ "is_valid_string", (PyCFunction)PyBitcoinAddressIsValidString, METH_FASTCALL | METH_STATIC, PyBitcoinAddressIsValidString_doc },{ "create_with_string", (PyCFunction)PyBitcoinAddressCreateWithString, METH_FASTCALL | METH_STATIC, PyBitcoinAddressCreateWithString_doc },{ "create_with_data", (PyCFunction)PyBitcoinAddressCreateWithData, METH_FASTCALL | METH_STATIC, PyBitcoinAddressCreateWithData_doc },{ "create_with_public_key", (PyCFunction)PyBitcoinAddressCreateWithPublicKey, METH_FASTCALL | METH_STATIC, PyBitcoinAddressCreateWithPublicKey_doc },{}
};
...
bool PyInit_BitcoinAddress(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "BitcoinAddress", (PyObject *) &PyBitcoinAddressType) < 0) {

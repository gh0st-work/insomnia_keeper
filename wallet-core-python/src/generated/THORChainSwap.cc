...
static const PyMethodDef method_defs[] = {{ "build_swap", (PyCFunction)PyTHORChainSwapBuildSwap, METH_FASTCALL | METH_STATIC, PyTHORChainSwapBuildSwap_doc },{}
};
...
bool PyInit_THORChainSwap(PyObject *module) {
  ...
  if (PyModule_AddObject(module, "THORChainSwap", (PyObject *) &PyTHORChainSwapType) < 0) {

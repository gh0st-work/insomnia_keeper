...
class SellScreen extends HookWidget{
  ...
  SellScreen({required this.coinName, required this.payment, required this.coinsBalance});

  List<MokTrades> trades = [
    MokTrades(price: "40000", from: "0.006", to: "0.08", coinsamount: "123", amountForPrice: "1"),
    MokTrades(price: "1000", from: "1", to: "10", coinsamount: "1000000", amountForPrice: "10"),
  ];
